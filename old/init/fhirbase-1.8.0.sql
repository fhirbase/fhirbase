...
CREATE TABLE IF NOT EXISTS "nutritionrequest" (
  id text primary key,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'NutritionRequest',
  status resource_status not null,
  resource jsonb not null
);

CREATE TABLE IF NOT EXISTS "nutritionrequest_history" (
  id text,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'NutritionRequest',
...
CREATE TABLE IF NOT EXISTS "servicedefinition" (
  id text primary key,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ServiceDefinition',
  status resource_status not null,
  resource jsonb not null
);

CREATE TABLE IF NOT EXISTS "servicedefinition_history" (
  id text,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ServiceDefinition',
...
CREATE TABLE IF NOT EXISTS "diagnosticrequest" (
  id text primary key,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'DiagnosticRequest',
  status resource_status not null,
  resource jsonb not null
);

CREATE TABLE IF NOT EXISTS "diagnosticrequest_history" (
  id text,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'DiagnosticRequest',
...
CREATE TABLE IF NOT EXISTS "imagingmanifest" (
  id text primary key,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ImagingManifest',
  status resource_status not null,
  resource jsonb not null
);

CREATE TABLE IF NOT EXISTS "imagingmanifest_history" (
  id text,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ImagingManifest',
