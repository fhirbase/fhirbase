...
CREATE TABLE IF NOT EXISTS "implementationguideoutput" (
  id text primary key,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ImplementationGuideOutput',
  status resource_status not null,
  resource jsonb not null
);

CREATE TABLE IF NOT EXISTS "implementationguideoutput_history" (
  id text,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ImplementationGuideOutput',
...
CREATE TABLE IF NOT EXISTS "implementationguideinput" (
  id text primary key,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ImplementationGuideInput',
  status resource_status not null,
  resource jsonb not null
);

CREATE TABLE IF NOT EXISTS "implementationguideinput_history" (
  id text,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ImplementationGuideInput',
