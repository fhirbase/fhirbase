...
CREATE TABLE IF NOT EXISTS "imagingexcerpt" (
  id text primary key,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ImagingExcerpt',
  status resource_status not null,
  resource jsonb not null
);

CREATE TABLE IF NOT EXISTS "imagingexcerpt_history" (
  id text,
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'ImagingExcerpt',
...
CREATE TABLE IF NOT EXISTS "protocol" (
  ...
  txid bigint not null,
  ts timestamptz DEFAULT current_timestamp,
  resource_type text default 'Protocol',
  status resource_status not null,
  resource jsonb not null
);
